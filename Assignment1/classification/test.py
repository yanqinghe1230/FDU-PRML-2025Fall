...
# ============== 学生信息（请填写） ==============
STUDENT_NAME = "梁灿"   # 例如：张三
STUDENT_ID   = "23307130417"   # 例如：2025123456
# ==============================================

def test_basic():
    print("[BASIC] accuracy / MSE")
    # accuracy: 3/4 = 0.75
    yt = np.array([0, 1, 0, 1, 1, 0, 1, 0, 0])
    yp = np.array([1, 1, 1, 1, 1, 0, 0, 0, 0])
    try:
    ...
    yt_r = np.array([0, 1, 0, 1, 1, 0, 1, 0, 0])
    yp_r = np.array([1, 1, 1, 1, 1, 0, 0, 0, 0])
    try:
